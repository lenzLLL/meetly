...
export function AppSidebar(){
    ...
    const upgradeInfo = getUpgradeInfo()
        return (
        <Sidebar collapsible="none" className="border-r border-sidebar-border h-screen bg-gradient-to-br from-[#0e001a] via-[#1a0033] to-[#100020]">
                            ...
                            {items.map((item) => (
                                <SidebarMenuItem key={item.title}>
                                    <SidebarMenuButton
                                        ...
                                        className="w-full justify-start gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors hover:bg-purple-700 hover:text-sidebar-accent-foreground data-[active=true]:bg-gradient-to-r data-[active=true]:from-purple-500 data-[active=true]:to-purple-700 data-[active=true]:text-sidebar-primary-foreground"
                                    >
                                        <Link href={item.url}>
                    ...
                    <div className="rounded-lg bg-[#1a0b2e]/70 backdrop-blur-md border border-[#3b186b]/40 p-4">
                        <div className="space-y-3">
                            ...
                            {upgradeInfo.showButton && (
                                <Link href="/pricing">
                                    <Button className="w-full rounded-md bg-gradient-to-r from-[#6a0dad] to-[#5f24e7]  px-3 py-2 text-xs font-medium text-sidebar-primary-foreground transition-colors hover:bg-sidebar-primary/90 cursor-pointer">
                                        {upgradeInfo.title}
                                    </Button>
                                </Link>
                            )}
